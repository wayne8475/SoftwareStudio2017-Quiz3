...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__role_js__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__turn_js__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__banner_css__ = __webpack_require__(23);
...
var Banner = function (_Component) {
    ...
    function Banner(root) {
        ...
        var Roles = root.querySelectorAll(__WEBPACK_IMPORTED_MODULE_1__role_js__["a" /* default */].getRootClass());
        _this.role_X = new __WEBPACK_IMPORTED_MODULE_1__role_js__["a" /* default */](Roles[0], 1);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__component_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__cell_js__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__grid_css__ = __webpack_require__(25);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__component_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__reset_css__ = __webpack_require__(26);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__component_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__cell_css__ = __webpack_require__(24);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__component_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__banner_js__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__grid_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__reset_js__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__main_css__ = __webpack_require__(6);
...
var Main = function (_Component) {
    ...
    function Main(root) {
        ...
        _this.grid.on('changeTurn', _this.handleChangeTurn.bind(_this));
        _this.grid.on('win', _this.handleWin.bind(_this));
        _this.grid.on('draw', _this.handleDraw.bind(_this));

        _this.reset = new __WEBPACK_IMPORTED_MODULE_3__reset_js__["a" /* default */](root.querySelector('.reset'));
        _this.reset.on('resetClick', _this.resetClick.bind(_this));
        return _this;
    }
    ...
    _createClass(Main, [{
        ...
        value: function handleChangeTurn(firer) {
            this.banner.changeTurn();
        }
    }, {
        key: 'handleWin',
        value: function handleWin(firer, winner) {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__component_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__role_css__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__role_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__role_css__);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var Role = function (_Component) {
    ...
    function Role(root, player) {
        ...
        if (player == 1) {
            root.textContent = "X: " + _this.score;
        } else {
            root.textContent = "O: " + _this.score;
        }
        return _this;
    }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__component_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__turn_css__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__turn_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__turn_css__);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var Trun = function (_Component) {
    _inherits(Trun, _Component);

    _createClass(Trun, null, [{
        key: 'getRootClass',
        value: function getRootClass() {
            return '.turn';
        }
...
/* harmony default export */ __webpack_exports__["a"] = (Trun);
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/index.js!./role.css", function() {
			var newContent = require("!!../node_modules/css-loader/index.js!./role.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/index.js!./turn.css", function() {
			var newContent = require("!!../node_modules/css-loader/index.js!./turn.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
